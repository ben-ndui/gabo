...
class _GameDetailsState extends State<GameDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    gameController.gameStatus(context);
    return Scaffold(
      appBar: SmoothUtile().buildAppBar(
        title: "${gameController.gameSelected?.title}",
                  ...
                  ? SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          buildStartButton(users, controller, context),
                        ],
                      ),
                    )
                  : Container(
  ...
  Padding buildStartButton(
    ...
    return Padding(
      padding: EdgeInsets.symmetric(
        horizontal: SmoothConfig.screenWidth! * 0.055,
      ),
      child: Row(
          ...
          Expanded(
            child: ElevatedButton(
              onPressed: () {
                //TODO : Launch game
                if (users.length >=
                    int.parse(controller.gameSelected!.nbJoueur)) {
                  context.router.replace(const GameScreen());
                } else {
                  buildShowDialogLeaveGame(context);
                }
              },
  ...
  Future<String?> buildShowDialogLeaveGame(BuildContext context) {
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SmoothText(
                        text:
                        "Il manque des joueurs, souhaitez vous commencer quand même la partie ?",
                        ...
                        children: [
                          TextButton(
                            onPressed: () {
                              ...
                              context.read<GameEngine>().init(controller);
                              //context.router.replace(const GameScreen());
                            },
                            child: const SmoothText(
                              text: "Oui",
  ...
  Expanded buildUsersList(List<AppUser> users) {
    return Expanded(
          ...
          return Card(
            ...
            child: ListTile(
              ...
              title: SmoothText(
                ...
                style: const TextStyle(color: SmoothColor.accent),
              ),
            ),
          );
        },
